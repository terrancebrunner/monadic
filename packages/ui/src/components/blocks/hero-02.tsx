...
export default function Hero() {
  return (
    <div className="min-h-160 bg-primary text-primary-foreground flex items-center justify-center">
      <div className="max-w-(--breakpoint-xl) w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 py-12">
        <div>
          ...
          <p className="mt-6 max-w-[60ch] sm:text-lg text-primary-foreground/80">
            Explore a collection of Shadcn UI blocks and components, ready to
            preview and copy. Streamline your development workflow with
            easy-to-implement examples.
          </p>
          <div className="mt-12 flex items-center gap-4">
            <Button size="lg" variant="ghost" className="rounded-full text-base">
