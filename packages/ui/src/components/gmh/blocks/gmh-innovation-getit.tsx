      ...
      <div>
        <Card className="p-8 bg-white shadow-2xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg cursor-pointer">
                  ...
                  <span className="text-sm text-[#033C5A]">Complete Documentation</span>
                </div>
                
                <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg cursor-pointer">
                  <Video className="w-5 h-5 text-[#033C5A]" />
                  <span className="text-sm text-[#033C5A]">Video Tutorials</span>
                </div>
                
                <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg cursor-pointer">
                  <FileText className="w-5 h-5 text-[#033C5A]" />
                  <span className="text-sm text-[#033C5A]">Quick Start Guide</span>
                </div>
                
                <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg cursor-pointer">
                  <Download className="w-5 h-5 text-[#033C5A]" />
                  <span className="text-sm text-[#033C5A]">Downloadable Resources</span>
                </div>
              </div>
            ...
            <div className="bg-gray-100 rounded-lg p-8 flex items-center justify-center relative overflow-hidden"
